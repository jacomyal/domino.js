...
e[n]=d.properties[n]:q('The key "'+n+'" is not a method nor a property.');h=h.concat(d.services||[]);for(g in e)if(void 0===z[g])q("The property is not referenced.");else if(w(g,e[g])){for(a in u[g])x(u[g][a],{parameters:[o.getEvent(g,i())]});for(a in v[g]||[])p[v[g][a]]=1}for(n in h||[])M(h[n].service,h[n].params);f=[];for(k in p)o.dispatchEvent(k,i()),f.push(o.getEvent(k,i()));f.length&&l(f)}b.abort&&W[m.id]&&W[m.id].abort();W[m.id]=D.ajax(c)};return o}function k(b,a){var c,s={},h={},p,d,f;void 0===
b&&r("Module class not specified.");"function"!==j.get(b)&&r("First parameter must be a function.");b.apply(s,(a||[]).concat(i()));p=s.triggers||{};for(f in p.events||{})O[f]=O[f]||[],O[f].push(p.events[f]);for(d in p.properties||{}){for(c in v[d]||[])u[d]=u[d]||[],u[d].push(p.properties[d]);void 0!==C[d]&&(e(d),x(p.properties[d],{parameters:[o.getEvent("domino.initialUpdate",i())]}))}for(f in N||{})h[f]=1;for(f in J||{})h[f]=1;for(f in P||{})h[f]=1;for(f in h)s.addEventListener(f,l);V.push(s);return s}
function l(b,a){var c,e,f,d,h,g,k,j,r=[];c=[];var t=a||{},y={},B={};t.loop=(t.loop||0)+1;var C=D.array(b);for(e in C)c.push(C[e].type);E("Iteration "+t.loop+" (main loop) :",c);for(e in C){h=C[e];for(f in g=h.data||{},c=N[h.type]||[],c)if(k=!!t.force,void 0!==g[c[f]]&&(k=w(c[f],g[c[f]])||k),k){for(d in u[c[f]])x(u[c[f]][d],{parameters:[o.getEvent(c[f],i())]});for(d in v[c[f]]||[])y[v[c[f]][d]]=1}for(d in O[h.type])x(O[h.type][d],{parameters:[h]});for(f in J[h.type]||[]){g=x(J[h.type][f],{parameters:[h],
scope:{call:!0}});c=D.array(g.events);for(d in c)y[c[d]]=1;for(d in g.properties)void 0===B[d]?B[d]=g.properties[d]:q('The property "'+d+'" is not a method nor a property.');r=r.concat(g.services||[])}for(f in P[h.type]||[])y[P[h.type][f]]=1}for(j in B)if(void 0===z[j])q("The property is not referenced.");else if(w(j,B[j])){for(e in u[j])x(u[j][e],{parameters:[o.getEvent(j,i())]});for(e in v[j]||[])y[v[j][e]]=1}for(d in r||[])M(r[d].service,r[d].params);c=[];for(h in y)o.dispatchEvent(h,i()),c.push(o.getEvent(h,
i()));c.length&&l(c,t)}function h(b){var a,c,e,f=[],d={};null==b&&q("Nothing to update.");if("array"===j.get(b))for(c in b)if(f.push(b[c].property),void 0===z[b[c].property])q("The property is not referenced.");else{if(w.apply([b[c].property,b[c].value].concat(b[c].parameters||[]))){for(a in u[b[c].property])x(u[b[c].property][a],{parameters:[o.getEvent(b[c].property,i())]});for(a in v[b[c].property]||[])d[v[b[c].property][a]]=1}}else if("object"===j.get(b))for(c in b){if(f.push(c),z[c]&&w(c,b[c])){for(a in u[c])x(u[c][a],
{parameters:[o.getEvent(c,i())]});for(a in v[c]||[])d[v[c][a]]=1}}else q("The properties must be stored in an array or an object.");E("Updating properties :",f);a=[];for(e in d)o.dispatchEvent(e,i()),a.push(o.getEvent(e,i()));a.length&&l(a,b);return this}function e(b){if(C[b]){if(aa[b]){for(var a=[],c={},e=1,f=arguments.length;e<f;e++)a.push(arguments[e]);c[b]=G[b];return x(C[b],{parameters:a,inputValues:c}).returned}return C[b]()}q('Property "'+b+'" not referenced.')}function w(b,a){if(z[b]){if($[b]){var c,
e;c=[];e={};e[b]=a;for(var f=1,d=arguments.length;f<d;f++)c.push(arguments[f]);e=x(z[b],{parameters:c,inputValues:e});(c="boolean"!==j.get(e.returned)||e.returned)&&(G[b]=e.properties[b]);return c}return z[b].call(i(),a)}q('Property "'+b+'" not referenced.');return!1}function M(b,a){if(S[b])S[b](a);else q('Service "'+b+'" not referenced.');return this}function x(b,a){var c,e,f=a||{},d=i(f.scope);"function"!==j.get(b)&&r("The first parameter must be a function");for(c in f.inputValues||{})d[c]=f.inputValues[c];
e={returned:b.apply(d,f.parameters||[]),properties:{},events:{},services:[]};null!=d.events&&!j.check("array",d.events)?q("Events must be stored in an array."):e.events=d.events;for(c in d)void 0!==z[c]?e.properties[c]=d[c]:void 0===Q[c]&&q('The key "'+c+'" is not a method nor a property.');for(c in f.inputValues)e.properties[c]=d[c];for(c in d.services)e.services[c]=d.services[c];return e}function K(b){return Z[b]}function L(b){return I[b]}function q(b){var a=["["+o.name+"]"];y.strict||a.push("WARNING");
for(var c in arguments)a.push(arguments[c]);X.apply(o,a)}function r(b){var a=["["+o.name+"]"],c;for(c in arguments)a.push(arguments[c]);U.apply(o,a)}function E(){var b=["["+o.name+"]"],a;for(a in arguments)b.push(arguments[a]);Y.apply(o,b)}function F(b){var a=arguments.length,c=(b||"").toString().match(RegExp("^"+y.shortcutPrefix+"(\\w+)$"));if(!c||!c.length)return b;c=c[1];if("function"===j.get(T[c]))return T[c].call(i());if("function"===j.get(C[c]))return e(c);for(var d=1;d<a;d++)if(void 0!==(arguments[d]||
{})[c])return arguments[d][c];return b}ba.call(this);var o=this,D=B.utils,j=D.type,H={},Z={},I={},C={},z={},G={},aa={},$={},V=[],N={},v={},O={},u={},J={},P={},S={},W={},T={},Q={events:1,services:1,hacks:1};(function(){for(var b in Object.prototype)Q[b]=1;for(b in i({full:1}))Q[b]=1})();var t={};this.name="domino";"string"===j.get(a)?this.name=a:void 0!==a&&"object"===j.get(a)?t=a:void 0!==f&&"object"===j.get(f)&&(t=f);this.name=t.name||this.name;(function(){for(var b in t.properties||[])d(t.properties[b].id,
