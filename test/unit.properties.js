...
test('test 1', function() {
  ...
  o.m.s.dispatch('def');
  deepEqual(o.m.s.historic[o.m.s.historic.length-1], 'def', 'The property has been successfully updated!');
});
test('test 2', function() {
  ...
  o.m.s.dispatch('def');
  deepEqual(o.m.s.historic.length, 2, 'Updating the property with a new value effectively triggers the events.');
});
test('test 3', function() {
  ...
  o.m.s.dispatch('abc');
  deepEqual(o.m.s.historic.length, 1, 'Updating the property with the same value does not trigger the events.');
});